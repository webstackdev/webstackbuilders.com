...
import JSDomTscompileEnvironment from '../environment/browser-env'
...
export const getJsdomEnv = (options?: TestEnvironmentOptions) => {
  return new JSDomTscompileEnvironment(
    {
